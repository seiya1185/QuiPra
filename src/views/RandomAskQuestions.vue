      ...
      <div class="quiz_content">
        ...
        <div class="answer" v-if="answerShow">
          <p>
            A.
            {{
              shuffleQuizData[arrayNumber]._delegate._document.data.value
...
export default {
  ...
  beforeMount() {
    ...
    // 選択肢をシャッフルして代入
    let letter1 =
      this.shuffleQuizData[this.arrayNumber]._delegate._document.data.value
  ...
  mounted() {
    for (const post of this.shuffleQuizData) {
